...
const AddHomeBanner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true)
    try {
      await postData('/api/homeSlider/create', { images: formFields.images })
      context.openAlertBox('success', 'Banner added successfully')
      ...
      <form onSubmit={handleSubmit} className='max-w-4xl mx-auto flex flex-col gap-6'>
        ...
        <div>
          ...
          <p className='text-[12px] mt-1' style={{ color: C.muted }}>
            Upload banner images. Each image will be shown in the home slider.
          </p>
        </div>
